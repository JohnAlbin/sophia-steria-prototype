StatsClient={LogVisit:function(pageNodeId,randomId){var trackingCookieName="sf-trckngckie";
var trackingId=this.readCookie(trackingCookieName);
if(!trackingId){trackingId=randomId;
this.createCookie(trackingCookieName,trackingId,180);
}var xmlHttp=null;
xmlHttp=new XMLHttpRequest();
xmlHttp.open("GET",this.getServiceUrl()+"?pageNodeId="+pageNodeId+"&trackingId="+trackingId+"&referrer="+document.referrer+"&pageUrl="+window.location.href,false);
xmlHttp.send(null);
